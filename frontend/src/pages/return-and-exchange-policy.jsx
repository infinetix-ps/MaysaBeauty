  ...
  const sections = [
    {
      id: "exchange",
      title: "التبديل",
      content: "نحن نوفّر خيار التبديل في حال كانت هناك مشكلة في المنتج، ويتم ذلك من خلال التواصل معنا مباشرة عبر الواتس آب خلال مدة أقصاها 3 أيام من تاريخ الاستلام، مع ضرورة أن يكون المنتج بحالته الأصلية وغير مستخدم."
    },
    {
      id: "return",
      title: "الإرجاع",
      content: "نأسف، لا يمكن إرجاع المنتجات بعد إتمام عملية الشراء، وذلك حرصًا على جودة منتجاتنا ونظافتها."
    }
  ];
    ...
    <div className="min-h-screen bg-[hsl(0,0%,100%)]">
      ...
      <div className="bg-[hsl(0,33%,60%)] text-[hsl(0,0%,100%)] py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-tight">سياسة التبديل والإرجاع</h1>
          <p className="text-xl md:text-2xl font-light max-w-3xl mx-auto opacity-90">
            تعرف على شروط وأحكام التبديل والإرجاع لمنتجاتنا
          </p>
        </div>
      </div>
